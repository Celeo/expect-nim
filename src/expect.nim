...
proc expectTrue*(a: bool) {.raises: [ExpectError].} =
...
proc expectFalse*(a: bool) {.raises: [ExpectError].} =
...
proc expectEqual*(a, b: auto) {.raises: [ExpectError].} =
...
proc expectNotEqual*(a, b: auto) {.raises: [ExpectError].} =
...
proc expectStringEqual*(a, b: auto) {.raises: [ExpectError].} =
...
proc expectStringNotEqual*(a, b: auto) {.raises: [ExpectError].} =
...
proc expectLessThan*(a, b: SomeNumber) {.raises: [ExpectError].} =
...
proc expectLessThanEqual*(a, b: SomeNumber) {.raises: [ExpectError].} =
...
proc expectGreaterThan*(a, b: SomeNumber) {.raises: [ExpectError].} =
...
proc expectGreaterThanEqual*(a, b: SomeNumber) {.raises: [ExpectError].} =
